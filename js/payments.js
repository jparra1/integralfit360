...
function selectS(button, price, duration) {
    ...
    button.style = "width: auto; background-color: #012626; font-weight: bold; font-size: 10px;"
}
...
function limpiar() {
    ...
    document.getElementById("bs1").style = "font-weight: bold; font-size: 10px;"
    document.getElementById("bs2").className = "btn btn-info button2"
    document.getElementById("bs2").style = "font-weight: bold; font-size: 10px;"
    document.getElementById("bs3").className = "btn btn-info button2"
    document.getElementById("bs3").style = "font-weight: bold; font-size: 10px;"

    document.getElementById("bh1").className = "btn btn-info button2"
    document.getElementById("bh1").style = "font-weight: bold; font-size: 10px;"
    document.getElementById("bh2").className = "btn btn-info button2"
    document.getElementById("bh2").style = "font-weight: bold; font-size: 10px;"
    document.getElementById("bh3").className = "btn btn-info button2"
    document.getElementById("bh3").style = "font-weight: bold; font-size: 10px;"

    document.getElementById("bc1").className = "btn btn-info button2"
    document.getElementById("bc1").style = "font-weight: bold; font-size: 10px;"
    document.getElementById("bc2").className = "btn btn-info button2"
    document.getElementById("bc2").style = "font-weight: bold; font-size: 10px;"
    document.getElementById("bc3").className = "btn btn-info button2"
    document.getElementById("bc3").style = "font-weight: bold; font-size: 10px;"
